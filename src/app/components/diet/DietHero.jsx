  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt="Balanced meal prepared for a training plan"
      ...
      >
        <div className="max-w-2xl">
          ...
          >
            Plans Built Around The Food You Already Eat — Not A Boiled-Chicken
            Punishment List. Your Coach Maps Every Meal To Your Goal, Your
            Schedule And Your Kitchen.
          </motion.p>
          ...
          >
            {STATS.map((s, i) => (
              ...
              >
                ...
                <span className="font-nav whitespace-pre-line text-[10px] font-bold uppercase leading-snug text-white sm:text-xs">
                  {s.label}
                </span>
              </div>
            ))}
          ...
          >
            ...
            >
              GET MY DIET PLAN <ArrowRight size={18} />
            </a>
            <a
